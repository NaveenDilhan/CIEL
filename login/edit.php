...
if(isset($_POST['fname']) && 
   isset($_POST['uname'])){
      ...
      if (isset($_FILES['pp']['name']) AND !empty($_FILES['pp']['name'])) {
         ...
         if($error === 0){
            ...
            if(in_array($img_ex_to_lc, $allowed_exs)){
               ...
               header("Location: ../accounts.php?success=Your account has been updated successfully");
                exit;
            }else {
               $em = "You can't upload files of this type";
               header("Location: ../accounts.php?error=$em&$data");
               exit;
            }
         }else {
	...
	header("Location: ..//accounts.php?error=error");
	exit;
}
